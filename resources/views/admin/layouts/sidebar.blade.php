    ...
    <div class="sidepanel-inner d-flex flex-column">
        ...
        <div class="app-branding">
            <a class="app-logo" href="index.html"><img class="logo-icon me-2"
                    ...
                    class="logo-text">Rental Mobil</span>
            </a>
        </div>
        <!--//app-branding-->
        ...
        <nav id="app-nav-main" class="app-nav app-nav-main flex-grow-1">
            <ul class="app-menu list-unstyled accordion" id="menu-accordion">
                ...
                <li class="nav-item">
                    <!--//Bootstrap Icons: https://icons.getbootstrap.com/ -->
                    <a class="nav-link @if(Request::is('admin/reports')) active @endif" href="{{url('admin/reports')}}">
                        <span class="nav-icon">
                            <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"
                ...
                <li class="nav-item has-submenu">
                    <!--//Bootstrap Icons: https://icons.getbootstrap.com/ -->
                    <a class="nav-link submenu-toggle @if (Request::is('admin/general') || Request::is('admin/payment')) active @endif" href="#" data-bs-toggle="collapse"
                    ...
                    <div id="submenu-1" class="collapse submenu submenu-1" data-bs-parent="#menu-accordion">
                        <ul class="submenu-list list-unstyled">
                            <li class="submenu-item"><a class="submenu-link" href="notifications.html"><i class="fa fa-bank"></i> Payment & Bank</a></li>
                            <li class="submenu-item"><a class="submenu-link" href="{{url('general')}}"><i class="fa fa-building"></i> General</a>
                            </li>
                        </ul>
                    </div>
                </li>
