<div id="app-sidepanel" class="app-sidepanel">
    ...
    <div class="sidepanel-inner d-flex flex-column">
        ...
        <div class="app-branding">
            <a class="app-logo" href="/admin"><img class="logo-icon me-2"
                    src="{{ asset('assets/backend/assets/images/app-logo.svg') }}" alt="logo"><span
                    class="logo-text">{!!web_name()!!}</span>
            </a>
        </div>
        <!--//app-branding-->
        ...
        <nav id="app-nav-main" class="app-nav app-nav-main flex-grow-1">
            <ul class="app-menu list-unstyled accordion" id="menu-accordion">
                ...
                <li class="nav-item">
                    <!--//Bootstrap Icons: https://icons.getbootstrap.com/ -->
                    <a class="nav-link @if (Request::is('admin/vehicles')) active @endif" href="{{url('admin/vehicles')}}">
                        <span class="nav-icon">
                ...
                <li class="nav-item">
                    <!--//Bootstrap Icons: https://icons.getbootstrap.com/ -->
                    <a class="nav-link @if (Request::is('admin/orders')) active @endif" href="{{url('admin/orders')}}">
                        <span class="nav-icon">
...
<path fill-rule="evenodd" d="M1.646 4.646a.5.5 0 0 1 .708 0L8 10.293l5.646-5.647a.5.5 0 0 1 .708.708l-6 6a.5.5 0 0 1-.708 0l-6-6a.5.5 0 0 1 0-.708z"/>
                    ...
                    <div id="submenu-1" class="collapse submenu" data-bs-parent="#menu-accordion">
                        <ul class="submenu-list list-unstyled">
                            <li class="submenu-item"><a class="submenu-link @if(Request::is('admin/reports')) active @endif" href="/admin/reports">Order Reports</a></li>
                            <li class="submenu-item"><a class="submenu-link @if(Request::is('admin/add-reports')) active @endif" href="/admin/add-reports">Additional Reports</a></li>
                        </ul>
                    </div>
                </li><!--//nav-item-->
                ...
                <li class="nav-item">
                    ...
                    <a class="nav-link @if(Request::is('admin/users')) active @endif" href="{{url('admin/users')}}">
                        <span class="nav-icon">
                ...
                <li class="nav-item">
                    ...
                    <a class="nav-link @if(Request::is('admin/payments')) active @endif" href="{{url('admin/payments')}}">
                        <span class="nav-icon">
                ...
                <li class="nav-item">
                    ...
                    <a class="nav-link @if(Request::is('admin/setting')) active @endif" href="{{url('admin/setting')}}">
                        ...
                        <span class="nav-link-text">Setting Web</span>
                    </a>
                    <!--//nav-link-->
                </li>
